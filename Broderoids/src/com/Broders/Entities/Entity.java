...
/**
 * All entities will be derived from this class. It handles most of the logic
 * involed in positioning on the screen, as well as holding and dealing with the
 * body.
 * 
 * @author ntpeters
 * @author krgauthi
...
public abstract class Entity {
	...
	/**
	 * Initializes the Entity with the given Entity type. Also generates a new
	 * unique identity string from CoreLogic.
	 * 
	 * @param id
	...
	/**
	 * Gets the current Y-Coordinate of the Body position (meters). The world
	...
	/**
	 * Creates a new Body for the Entity and attaches a new Fixture to it, given
	 * Body and Fixture Definition objects.
	 * 
	 * @param bodDef
	...
	/**
	 * Returns the size of the Entity in meters. Size is used for drawing the
	 * sprite.
	 * 
	...
	/**
	 * Returns true if the given Entity is this Entity. Compares id strings to
	 * determine equality.
	 * 
	 * @param entity
	 ...
	 * Used for screen wrapping. Essentially creates a copy of the body from the
	 * body and fixture definitions in the new location, and destroys the
	 * original.
	 * 
	 * @param x
	...
	/**
	 * Returns a Vector2 containing the velocity of this Entity's body. The
	 * vector consists of an x and y direction components.
	 * 
	 ...
	 */
	public void teleport(String id, String type, float x, float y, float angle,
			float angleVel, float vX, float vY) {
	...
	/**
	 * Overridden by subclasses. Is called for every Entity in every iteration
	 * of the main loop. Contains any code that needs to be executed every loop
	 * that is not involved in drawing.
	 */
	public abstract void update();

	/**
	 * Overridden by subclasses. Gets called whenever an Entity needs to be
	 * destroyed. Contains any code that needs to execute upon destruction of
