...
/**
 * This enum will be used for handling the input direction.
 * Mostly here for now in case any additional values/handling need to be passed with a direction.
 * If that never becomes the case, this can be removed in favor of simply using Strings to denote direction.
 * 
 * @author ntpeters
 *
 */
public enum InputDir {
	 ...
	 * 
	 * @param	dir	Direction to compare against
